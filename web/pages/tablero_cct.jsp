        ...
        function drawBarColors() {
            var data = google.visualization.arrayToDataTable([
               ['City', 'pedro', {role: 'annotation'}],
                ...
                ['Hombre', <s:property value="datos.TOTAL_HOMBRE_GENERAL" />, '<s:property value="datos.TOTAL_HOMBRE_GENERAL" />'],
                ['Mujer', <s:property value="datos.TOTAL_MUJER_GENERAL" />, '<s:property value="datos.TOTAL_MUJER_GENERAL" />'],
            ]);
